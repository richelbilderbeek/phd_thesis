...
The difference between a known 'true' phylogeny and an inferred posterior
of phylogenies can be quantified using an error statistic. One way to
...
the nLTT statistic [Janzen et al., ?]. The latter we use ...
